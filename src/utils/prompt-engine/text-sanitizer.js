...
class TextSanitizer {
  static sanitize(rawText) {
    ...
    text = text
      ...
      .replace(/\bthay\s+has\b/gi, "they have")
      .replace(/\bhade\b(?=\s*(?:na|or|and|has|like|is|\.|\,|$))/gi, "head")
      ...
      .replace(/\blaguage\s*proficiancy\b/gi, "language proficiency")
      .replace(/\blanguage\s*proficiancy\b/gi, "language proficiency")
      .replace(/\blaguage\s*proficiency\b/gi, "language proficiency")
