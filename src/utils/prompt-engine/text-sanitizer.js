...
class TextSanitizer {
  static sanitize(rawText) {
    ...
    text = text
      ...
      // English for English Work Mixed STT normalizations (Law 54)
      .replace(/\b(?:use\s+)?english\s+for\s+english\s+work\s+(?:mixd|mixt|mixed)\b/gi, "use english for english work mixed")
      .replace(/\b(?:use\s+)?english\s+for\s+english\s+works?\b/gi, "use english for english work mixed")
      .replace(/\b(?:mix|mixed)\s+english\s+for\s+english\s+works?\b/gi, "use english for english work mixed")
      .replace(/\b(?:use\s+)?english\s+mixed\s+for\s+english\s+works?\b/gi, "use english for english work mixed")
      .replace(/\b(?:use\s+)?english\s+for\s+tech(?:nical)?\s+works?\s+mixed\b/gi, "use english for english work mixed")
